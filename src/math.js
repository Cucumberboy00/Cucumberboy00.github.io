...
class Interpolant {
  ...
  constructor(frames, stride) {
    ...
    this.#frames_ = frames;
    this.#interpolator_ = new THREE.LinearInterpolant(
        times, values, stride, this.#resultBuffer_);
  }
...
export {
  random, randomRange, lerp, remap, clamp, saturate, inverseLerp,
  Vec3Interpolant, FloatInterpolant, ColorInterpolant
};